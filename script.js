...
const container = document.getElementById('mainPaymentOptions');
if (!container) return;
container.innerHTML =   <h4 style="margin-bottom:10px; font-size: 14px;">Enter Card Details</h4>   <input type="number" id="cardNumber" placeholder="Card Number" style="width:100%; padding:10px; margin-bottom:8px; border:1px solid #ddd; border-radius:8px;">   <div style="display:flex; gap:10px; margin-bottom:10px;">   <input type="text" id="cardExpiry" placeholder="MM/YY" style="width:50%; padding:10px; border:1px solid #ddd; border-radius:8px;">   <input type="password" id="cardCvv" placeholder="CVV" style="width:50%; padding:10px; border:1px solid #ddd; border-radius:8px;">   </div>   <button class="btn-p" onclick="verifyCardAndPay()" style="width:100%;">Pay Now</button>   <button class="btn-t" onclick="resetPaymentOptions()" style="width:100%; margin-top:10px;">Back</button>  ;
}
